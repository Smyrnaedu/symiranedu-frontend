...
export const CONTACT_GET_ALL_BY_PAGE_API_ROUTE = `${appConfig.apiURL}/contact-messages/get`;
export const GET_ALL_STUDENTD_BY_PAGE_API_ROUTE = `${appConfig.apiURL}/smyrna/manager/students`;
