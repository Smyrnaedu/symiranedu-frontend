      ...
      <Row className="d-flex justify-between">
        <Col>
          ...
          <p className="banner-text">
            Gitmek istediğin ülkeyi ve almak istediğin eğitimi seç, fiyat
            teklifi al ve bizimle iletişime geç! Bütçene uygun dil okulu ve
            üniversite için anlık fiyatlar alın! Kendinize en uygun programları
            araştırın!
          </p>
        </Col>
        <Col>
